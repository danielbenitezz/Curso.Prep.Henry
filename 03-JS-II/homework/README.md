...
* `for` for es un tipo de bucle que se utilizaq pars realizar tareas repetitivas
* `&&`, `||`, `!` los operadores lógicos se utilizan  con valores booleanos; cuando lo son, devuelven un valor booleano. Sin embargo, los operadores && y || en realidad devuelven el valor de uno de los operandos especificados, por lo que si estos operadores se utilizan con valores no booleanos, pueden devolver un valor no booleano.
